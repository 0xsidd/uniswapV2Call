...
const tuniswapContract = new ethers.Contract('0xf34a35592b6e610807e92eaddc528efe4515d17d',abi,provider);
const tapeswapContract = new ethers.Contract('0x4268560cb21e72bf29c2508955ccaeb0ef99772c',abi,provider);
const tbiswapContract = new ethers.Contract('0xe3404c7a327b2ad5b4426133b7b50f0412a104ff',abi,provider);
...
const tokenAAddress = '0xE2444E4BC463aaf7cF7A52C844C93d3A95C22C72';
const tokenBAddress = '0x4a69d7e3113B1181653B261545EBe021C31D7E8A';
const TBUSDAddress = '0xD15cce62D3C9BE725ECC505618DdCD2e3f5b2148';
const TUSDTAddress = '0xFA0d30488EB6eB7a4ffe20AB0B6de39418f4994D';
const TUSDCAddress = '0x4933BD1ef80E8C51397025C45C4F7E47e5C871Af';
const WETHAddress = '0x1d25042149fB1895c192e2ba0F9aE8983Cd26D80';
...
await tuniswapContract.connect(wallet).addLiquidity(tokenAAddress,TBUSDAddress,TOKEN_A_AMOUNT,TOKEN_A_AMOUNT,1,1,wallet.address,1764541741);

await tokenA.connect(wallet).approve(tuniswapContract.address,TOKEN_A_AMOUNT);
await WETH.connect(wallet).approve(tuniswapContract.address,TOKEN_A_AMOUNT);
await tuniswapContract.connect(wallet).addLiquidity(tokenAAddress,WETHAddress,TOKEN_A_AMOUNT,TOKEN_A_AMOUNT,1,1,wallet.address,1764541741);

await tokenA.connect(wallet).approve(tapeswapContract.address,TOKEN_A_AMOUNT);
await WETH.connect(wallet).approve(tapeswapContract.address,TOKEN_A_AMOUNT);
await tapeswapContract.connect(wallet).addLiquidity(tokenAAddress,WETHAddress,TOKEN_A_AMOUNT,TOKEN_A_AMOUNT,1,1,wallet.address,1764541741);
